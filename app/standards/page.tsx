...
const standards = [
  ...
  },
  {
    ...
    copy: "Joy Health is an educational publisher, not a medical practice. We do not imply clinical authority we do not have, and we identify qualified reviewers by name and credentials only when they actually participated.",
  },
  {
