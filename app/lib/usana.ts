...
/** Number of products reviewed on the supplement guide. */
export const USANA_PRODUCT_COUNT = Object.keys(USANA_PRODUCT_IMAGES).length;

/** Products shown on the product shelf, in editorial order. */
export const PRODUCT_SHELF = [
  { key: "cellsentials", name: "CellSentials", role: "Daily foundation" },
  { key: "biomega", name: "BiOmega", role: "Omega-3" },
  { key: "coquinone", name: "CoQuinone 30", role: "Short label" },
  { key: "clearProtein", name: "Clear Protein + Creatine", role: "Active format" },
